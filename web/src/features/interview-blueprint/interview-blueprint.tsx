...
export function InterviewBlueprint() {
  ...
  return <PageShell active="new"><main className="content-container blueprint-page">
    ...
    <PageIntro eyebrow="步骤 3 / 3 · 面试蓝图" title={session ? "确认今天要练什么" : "确认面试蓝图"} description={session ? session.summary : "系统会根据已确认材料规划阶段、时长与能力范围。"} actions={session ? <StatusBadge tone="success"><CheckCircle2 size={13} />计划已保存</StatusBadge> : undefined} />
