  ...
  return <div className="meeting-app feishu-room">
    ...
    <main className={`meeting-main ${textPanel ? "with-answer-panel" : codingPanel && currentPhase?.kind === "coding" ? "with-coding-panel" : ""}`}>
      <section className="video-stage">
        ...
        <section className="ai-trace" aria-label="AI 工作轨迹"><header><span className="speaking-dot" /><strong>AI 工作轨迹 · 正在形成追问策略</strong><b>LIVE</b></header><div className="ai-trace-steps"><article className="done"><CheckCircle2 size={15} /><div><strong>读取简历与 JD</strong><span>已定位本轮岗位与经历上下文</span></div></article><article className="active"><span className="speaking-dot" /><div><strong>匹配回答证据</strong><span>正在关联当前回答与项目细节</span></div></article><article><Clock3 size={15} /><div><strong>更新追问计划</strong><span>等待本轮回答完成后生成</span></div></article></div></section>
      </section>
